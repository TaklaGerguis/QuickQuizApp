 ...
 */
public class shortAnswerView extends javax.swing.JFrame{

    /**
     * Creates new form shortAnswerView
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(shortAnswerView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new shortAnswerView().setVisible(true);
            }
        });
    }
